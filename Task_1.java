...
/**
 * Класс создает массив, заполняет его случайными значениями
 */
public class Task_1 {
    /**
     ...
     */
    public static long measureSearchTime(int[] array, int min, int max, int iterations, double precision) {
        return measureTime(() -> {
