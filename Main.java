...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        int searchIncrement = 10_000; // Количество итераций в циклах поиска
...
//        long searchRandomElementTime = Task_1.measureSearchTime(randomArray, min,max,searchIncrement,precision);
...
//                + searchRandomElementTime + " мс");
        ...
        int[] sortedArray = sortedArrayHolder[0]; // создаем новый одномерный массив и записываем в него первый элемент
        ...
        long interpolationSearchRandomElementTime = Task_2.interpolationSearchTime(sortedArray,min,max,searchIncrement);
        // Результат интерполяционного поиска
        System.out.println("Время поиска случайного элемента (" + searchIncrement + " итераций): "
                + interpolationSearchRandomElementTime + " мс");
    }
}
